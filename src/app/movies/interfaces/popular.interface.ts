// To parse this data:
//
//   import { Convert, PopularMovies } from "./file";
//
//   const popularMovies = Convert.toPopularMovies(json);
//
...
export class Convert {
    public static toPopularMovies(json: string): PopularMovies {
        return cast(JSON.parse(json), r("PopularMovies"));
    }

    public static popularMoviesToJson(value: PopularMovies): string {
        return JSON.stringify(uncast(value, r("PopularMovies")), null, 2);
    }
}
